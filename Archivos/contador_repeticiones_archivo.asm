...
section .data
	...
	path1 db "/home/josselyn/Documentos/ensamblador/Archivos/numeros.txt", 0
	path2 db "/home/josselyn/Documentos/ensamblador/Archivos/resultado_repeticiones.txt", 0
