...
section .data
    ...
    pathsumando1 db "/home/josselyn/Documentos/ensamblador/Archivos/arreglo1.txt",0
    lenpathsumando1 equ $ - pathsumando1

    pathsumando2 db "/home/josselyn/Documentos/ensamblador/Archivos/arreglo2.txt",0
    lenpathsumando2 equ $ - pathsumando2 

    pathresultado db "/home/josselyn/Documentos/ensamblador/Archivos/arreglo2.txt",0
